...
+ 'FN:Mr.Pato\n' // Nama
+ 'ORG:Mr.Pato-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=51989730621:+51 989 730 621\n' // Nomor bot
+ 'END:VCARD' 
...
Usa ${prefix}verify para verificarte y poder usar el bot.`
				...
				num = anu.participants[0]
				teks = `Se fue el llorón @${num.split('@')[0]} hijo de su mami que tiene mamitis y papitis ;)!    `
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
  ...
  only: {
    ...
    admin: 'Debes de ser admin para este comando weon ',
